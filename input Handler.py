...
def train_word2vec(documents, embedding_dim,model_save):
    """
    ...
    if os.path.isfile(model_save):
        ...
        model.train(documents, min_count=1, size=embedding_dim)
    else:
...
def word_embed_meta_data(documents, embedding_dim,model_save):
    """
    ...
    word_vector = train_word2vec(documents, embedding_dim,model_save)
